...
# -*- coding: utf-8 -*-
#
# autofonce documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'autofonce.tex', 'autofonce Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'autofonce', 'autofonce Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'autofonce', 'autofonce Documentation',
     author, 'autofonce', 'One line description of project.',
     'Miscellaneous'),
]
